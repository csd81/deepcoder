...
export const SLASH_CATALOG: SlashCommandInfo[] = [
  ...
  { name: "branch", args: "[-c|-d|-m <name>|<name>]", description: "List/create/delete/rename/switch branches", category: "git" },
  ...
  { name: "push", args: "[--force] [--review]", description: "Push to origin (confirmed; --review runs a pre-push diff review)", category: "git" },
  ...
  { name: "show", args: "[<ref>]", description: "Show a commit/object (diff + metadata)", category: "git" },
  { name: "files", args: "[<paths>]", description: "List tracked files", category: "git" },
  { name: "stage", args: "[-A | <path...>]", description: "Stage all or specific paths", category: "git" },
  { name: "restore", args: "[--staged] <path...>", description: "Discard working-tree changes or unstage paths (confirmed)", category: "git" },
  { name: "apply", args: "<patch-file> [--check] [--3way]", description: "Apply a patch file (confirmed)", category: "git" },
  { name: "worktree", args: "[list|add <dir> [-b <branch>]|remove <dir>|prune]", description: "Manage linked worktrees (confirmed)", category: "git" },
  { name: "tag", args: "<name> | -a <name> [-m <msg>] | -d <name>", description: "Create/delete tags (confirmed)", category: "git" },
  // session
  ...
  { name: "scaffold", args: "<kind> <name> [sample-path]", description: "Generate a new file matching a sample's style", category: "session" },
  ...
  { name: "export", args: "[plan] [--sanitize] [--stdout]", description: "Export the session (or `plan` = approved-plan handoff) to JSON", category: "session" },
  ...
  { name: "batch", args: "<task>", description: "Decompose a task into a runnable, path-disjoint delegation plan", category: "delegate" },
  { name: "pipeline", args: "<task>", description: "Research (read-only) then implement, feeding research as context", category: "delegate" },
