---
name: building-llm-apps-deepseek
description: Build LLM-powered applications with the DeepSeek API — choosing the right surface (single call, pipeline, stateful agent), model defaults, streaming, tool use, and batch processing.
---
