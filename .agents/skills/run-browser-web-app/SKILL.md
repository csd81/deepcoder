---
name: run-browser-web-app
description: Template for writing a run skill for a browser-driven web app — start a dev server in the background, drive it with a headless browser (nav, wait, act, screenshot, check console errors), and cover app-specific gotchas.
---
