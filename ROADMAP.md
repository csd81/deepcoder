...
- [~] **4D** — subagents (design `plans/phase4d-subagents-design.md`): slice 1 shipped — read-only `reviewer` + `/review`; slice 2 planned in `plans/phase4d-slice2-research-plan.md`; parallel/model-callable deferred
