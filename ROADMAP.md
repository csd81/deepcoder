...
- [~] **4D** — subagents (design `plans/phase4d-subagents-design.md`): slices 1–2 shipped — read-only `reviewer` (`/review`) + `researcher` (`/research`), output quarantined out of model history; slice 3 planned in `plans/phase4d-slice3-test-triage-plan.md`; model-callable/parallel deferred
